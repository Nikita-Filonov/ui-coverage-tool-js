...
// src/tracker/storage.ts
var logger = getLogger("UI_COVERAGE_TRACKER_STORAGE");
var UICoverageTrackerStorage = class {
  ...
  async load() {
    ...
    if (!resultsDirStats.isDirectory()) {
...
var buildJsonSettings = () => cleanUndefined(
  loadFromJson(path2.join(cwd, "ui-coverage.config.json"))
);
var buildYamlSettings = () => cleanUndefined(
...
//# sourceMappingURL=chunk-2PQQ533Q.js.map